...
!function (t, e) {
    ...
    var v = {}, g = function (t) {
        ...
        yt = function () {
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? ut(n) : st(n), tt(n, e, "actions"), function (t, e, n) {
                var o = N(), i = U(), r = F();
                if (!o || !i || !r) return;
                Bt(o, "confirm", n), Bt(i, "deny", n), Bt(r, "cancel", n), function (t, e, n, o) {
    ...
    var Vt = function (t, e) {
            ...
            }(0, e), Vt(t, e), Pt(0, e), function (t, e) {
                var n = K();
    ...
    var Kn = new WeakMap, Yn = function () {
        return a((function t() {
    ...
    if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|by|xn--p1ai)$/)) {
        var eo = new Date, no = localStorage.getItem("swal-initiation");
